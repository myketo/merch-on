  ...
  <div class="flex items-center justify-center h-screen">
    <div>
      <div class="flex flex-col items-center space-y-2">
        ...
        <h1 class="text-4xl font-bold pb-2">Thank You !</h1>
        <p>
          Your order <b>{{ route.query.oid }}</b> has been placed.
        </p>
        <p class="pb-6">An email confirmation will be sent to your mailbox.</p>
        <RouterLink
          to="/"
